// js/modules/Welcome/screens/screen-2-family-name.js
// Screen 2: Family Name
// Ported from .legacy/js/welcome/screens/screen-2-family-name.js

import { createLogger } from '../../../utils/logger.js';
const logger = createLogger('FamilyNameScreen');

export const familyNameScreen = {
    id: 'screen-2',
    title: 'Family Name',
    canGoBack: true,
    canSkip: true,
            ...
            <div class="welcome-screen-content">
                ...
                ${!isEditing ? `
                    ...
                    <div class="welcome-actions">
                        <button id="welcome-screen-2-confirm" class="welcome-btn welcome-btn-primary" tabindex="1">
                            Looks Good!
                        </button>
                        <button id="welcome-screen-2-edit" class="welcome-btn welcome-btn-secondary" tabindex="2">
                            Edit
                        </button>
                    </div>
                ` : `
